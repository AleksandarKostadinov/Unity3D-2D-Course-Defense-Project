...
public class Player : MovingObject
{
    ...
    void Update()
    {
        ...
        //Get input from the input manager, round it to an integer and store in horizontal to set y axis move direction
        vertical = (int)Input.GetAxisRaw("Vertical");

        //Check if moving horizontally, if so set vertical to zero.
        //the coal is to restrict diagonal movement
        if (horizontal != 0)
        {
            vertical = 0;
        }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.tag == "Exit")
        {
            ...
            this.Invoke("Restart", this.reastartLevelDelay);
